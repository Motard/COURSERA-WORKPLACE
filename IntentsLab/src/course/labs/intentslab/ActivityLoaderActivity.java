...
public class ActivityLoaderActivity extends Activity {
	...
	// Constante usada para receber a String da ExplicitlyLoadedActivity
	public static final String EXTRA1 = "extra";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE)
		{
			...
			{
				//String txt = data.getStringExtra(CHOOSER_TEXT);
				mUserTextView.setText(data.getStringExtra(EXTRA1));
			}
		}
